                    ...
                    data-aos="zoom-in-up" data-aos-duration="700" data-aos-delay={project.dad}>
                        ...
                        <div>
                            ...
                            <div className='mt-8 text-center'>
                                <a href={project.link} target="_blank" rel="noopener noreferrer" className='bg-indigo-600 p-3 rounded-lg block border border-zinc-600 transition-all duration-300 ease-in-out hover:bg-indigo-500'>View Project</a>
                            </div>
                        </div>
                    </div>
                ))}
